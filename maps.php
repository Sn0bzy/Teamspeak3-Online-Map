...
$tsHandle = TeamSpeak3::factory("serverquery://".$cfg->TSinf->user.":".$cfg->TSinf->pass."@".$cfg->TSinf->host.":".$cfg->TSinf->qport."/?server_port=".$cfg->TSinf->port."&nickname=".urlencode($cfg->TSinf->nickname));
